"""
Django settings for genus_backend project.
...
SECRET_KEY = 'django-insecure-neo@rs-!chi7b)d)40k2#p&&klj5jc8*#ykw8*fi9#f91qo1l$'
...
ROOT_URLCONF = 'genus_backend.urls'
...
WSGI_APPLICATION = 'genus_backend.wsgi.application'
